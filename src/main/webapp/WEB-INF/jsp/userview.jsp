...
<%@include file="common/head.jsp"%>
 <div class="right">
        ...
        <div class="providerView">
            ...
            <p><strong>用户头像：</strong><img src="/statics/fileUpload/${user.picPath}" width="50" height="50"></p>
            <p><strong>证件照：</strong><img src="/statics/fileUpload/${user.picWorkPath}" width="60" height="100"></p>
